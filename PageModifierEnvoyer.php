<?php
    require "action/envoyer/gettersUpdateSend.php";
    require "action/envoyer/UpdateSend.php";
...
<div class="container">
  <form  method="POST">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="idenvoi"value="<?=$idEn?>" name="idenvoi" placeholder="ID">
      </div>  
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="colis"value="<?=$colis?>" name="colis" placeholder="colis">
      </div>  
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="nomEnvoyeur"value="<?=$NomE?>" name="nomEnvoyeur" placeholder="NOM">
      </div>  
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="Email" id="emailEnvoyeur"value="<?=$Email?>" name="emailEnvoyeur" placeholder="@gmail.com">
      </div>  
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="datetime-local" id="date_envoi"value="<?=$date_En?>" name="date_envoi" placeholder="">
      </div>  
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="nomRecepteur"value="<?=$NomR?>" name="nomRecepteur" placeholder="NOM">
      </div>  
    </div>
    <!--<div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="contactRecepteur"value="<?=$contR?>" name="contactRecepteur" placeholder="+261 34">
      </div>
    </div>
    <div class="row">
