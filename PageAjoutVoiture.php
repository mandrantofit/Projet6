<?php
    require "action/voiture/CreateCar.php";
...
<div class="container">
  <form  method="POST">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="identifiant" name="identifiant" placeholder="ID">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="designation" name="designation" placeholder="Nom du vehicule">
      </div>
    </div>
    <!--<div class="row">
      <div class="col-25">
